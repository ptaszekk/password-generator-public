...
const charactersAmountNumber = document.getElementById('charactersAmountNumber');
...
charactersAmountRange.addEventListener('input', syncCharacterNumber);
charactersAmountNumber.addEventListener('input', syncCharacterNumber);
